...
export function renderNode(params: {
  ...
  if (unsupported.has(key)) {
    return html`<div class="cfg-field cfg-field--error">
      ...
      <div class="cfg-field__error">${zhCN.ui.settings.unsupportedSchemaNode}</div>
    </div>`;
  }
  ...
  return html`
    <div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${label}</div>
      <div class="cfg-field__error">${zhCN.ui.settings.unsupportedType.replace("{type}", String(type))}</div>
    </div>
  `;
}
...
function renderTextInput(params: {
  ...
  const placeholder =
    hint?.placeholder ??
    (isSensitive ? "••••" : schema.default !== undefined ? zhCN.ui.settings.defaultPlaceholder.replace("{value}", String(schema.default)) : "");
      ...
      <div class="cfg-input-wrap">
        ...
        ${schema.default !== undefined ? html`
          <button
            ...
            title=${zhCN.ui.settings.resetToDefault}
            ?disabled=${disabled}
...
function renderSelect(params: {
  ...
  return html`
    <div class="cfg-field">
      ...
      >
        <option value=${unset}>${zhCN.ui.settings.select}</option>
...
function renderArray(params: {
  ...
  if (!itemsSchema) {
    return html`
      <div class="cfg-field cfg-field--error">
        <div class="cfg-field__label">${label}</div>
        <div class="cfg-field__error">${zhCN.ui.settings.arrayUnsupported}</div>
      </div>
    `;
  }
  ...
  return html`
    <div class="cfg-array">
      <div class="cfg-array__header">
        ...
        <span class="cfg-array__count">${zhCN.ui.settings.itemCount.replace("{count}", String(arr.length))}</span>
        <button
          type="button"
            ...
            <div class="cfg-array__item">
              <div class="cfg-array__item-header">
                ...
                <button
                  ...
                  title=${zhCN.ui.settings.removeItem}
                  ?disabled=${disabled}
                  @click=${() => {
                    const next = [...arr];
                    next.splice(idx, 1);
  ...
  return html`
    <div class="cfg-map">
      <div class="cfg-map__header">
        <span class="cfg-map__label">${zhCN.ui.settings.customEntries}</span>
        <button
          type="button"
          class="cfg-map__add"
          ?disabled=${disabled}
        ...
        >
          ...
          ${zhCN.ui.settings.addEntry}
        </button>
      </div>

      ${entries.length === 0 ? html`
        <div class="cfg-map__empty">${zhCN.ui.settings.noCustomEntries}</div>
      ` : html`
              ...
              <div class="cfg-map__item">
                <div class="cfg-map__item-key">
                  <input
                    ...
                    placeholder=${zhCN.ui.settings.key}
                    .value=${key}
                    ?disabled=${disabled}
                    @change=${(e: Event) => {
                  ...
                  ${anySchema
                    ? html`
                        <textarea
                          ...
                          placeholder=${zhCN.ui.settings.jsonValue}
                          rows="2"
                          .value=${fallback}
                          ?disabled=${disabled}
                          @change=${(e: Event) => {
                ...
                <button
                  ...
                  title=${zhCN.ui.settings.removeEntry}
                  ?disabled=${disabled}
                  @click=${() => {
                    const next = { ...(value ?? {}) };
                    delete next[key];
